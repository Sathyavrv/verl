...
if [ "$#" -lt 2 ]; then
    echo "Usage: run_deepscaler_qwen3_4b_instruct_grpo.sh <n_gpus_per_node> <save_path> [other_configs...]"
    exit 1
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    data.shuffle=False \
    actor_rollout_ref.model.path="/kaggle/input/qwen3-4b-instruct-2507" \
    ...
    trainer.project_name=deepscaler-grpo \
    trainer.experiment_name=deepscaler-grpo-qwen3-4b-instruct-2507 \
    trainer.device=cuda \
